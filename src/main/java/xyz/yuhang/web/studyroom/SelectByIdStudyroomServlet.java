...
@WebServlet("/selectByIdStudyroomServlet")
public class SelectByIdStudyroomServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/selectStudyroomServlet").forward(request,response);
