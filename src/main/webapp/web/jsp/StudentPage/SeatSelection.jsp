    ...
    <table class="layui-table" border="1" cellspacing="0" style=" width: 75%;">
      ...
      <c:forEach items="${studyroomLogs}" var="studyroomLog" varStatus="status">
        <tr>
          ...
          <td>
            <a id="x" href="${pageContext.request.contextPath}/addStudyCSServlet?srid=${studyroomLog.srid}&timeId=${studyroomLog.timeId}&date=${studyroomLog.date}">选择</a>
            <a id="s" href="${pageContext.request.contextPath}/delectStudyCSServlet?srid=${studyroomLog.srid}&timeId=${studyroomLog.timeId}&date=${studyroomLog.date}">删除</a>
