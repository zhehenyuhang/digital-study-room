...
<div class="layui-body">
    <div style="padding: 15px;height: 600px;">
        ...
        <div style=" margin: 0 -32px;">
            ...
            <form action="${pageContext.request.contextPath }/addAcademyServlet" method="post">

                    <label class="layui-form-label"><strong>学院名称:</strong></label>
                    <div class="layui-input-inline">
                            <input type="text" name="academyName" lay-verify="required"  autocomplete="off" class="layui-input">
                    </div>
                </div>
