...
<div class="layui-body">
    <div style="padding: 15px;height: 600px;">
        ...
        <div>
            <form action="${pageContext.request.contextPath }/updataAcademyServlet" method="post">
                <input value="${academy.id}" name="id" type="hidden">

                <div style=" margin: 0 -32px;">
                    <label class="layui-form-label"><strong>学院名称:</strong></label>
                    <div class="layui-input-inline">
                        <input value="${academy.academyName}" name="academyName" lay-verify="required"  autocomplete="off" class="layui-input">
                    </div>
                </div>
