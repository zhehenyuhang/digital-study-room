...
!function (e, t) {
    ...
    var a = e.layui && layui.define, n = {
        ...
        }, w = "yyyy|y|MM|M|dd|d|HH|xyz.yuhang.test.H|mm|m|ss|s";
    r.formatArr = function (e) {
        ...
        var t, a, n = this, i = (new Date, n.config), r = n.lang(), o = i.dateTime = i.dateTime || n.systemDate(),
            s = n.bindElem || i.elem[0], y = (n.isInput(s) ? "val" : "html", function () {
                ...
                t = (t.match(n.EXP_SPLIT) || []).slice(1), l = l || 0, i.range && (n[r[l]] = n[r[l]] || {}), lay.each(n.format, function (o, s) {
                    ...
                    t[o].length < s.length && (a = !0), /yyyy|y/.test(s) ? (y < m[0] && (y = m[0], a = !0), e.year = y) : /MM|M/.test(s) ? (y < 1 && (y = 1, a = !0), e.month = y - 1) : /dd|d/.test(s) ? (y < 1 && (y = 1, a = !0), e.date = y) : /HH|xyz.yuhang.test.H/.test(s) ? (y < 1 && (y = 0, a = !0), e.hours = y, i.range && (n[r[l]].hours = y)) : /mm|m/.test(s) ? (y < 1 && (y = 0, a = !0), e.minutes = y, i.range && (n[r[l]].minutes = y)) : /ss|s/.test(s) && (y < 1 && (y = 0, a = !0), e.seconds = y, i.range && (n[r[l]].seconds = y))
                }), d(e)
            };
        ...
        return e = e || {}, "string" == typeof t && (t = r.formatArr(t)), t = (t || []).concat(), lay.each(t, function (n, i) {
            /yyyy|y/.test(i) ? t[n] = lay.digit(e.year, i.length) : /MM|M/.test(i) ? t[n] = lay.digit(e.month + (a || 0), i.length) : /dd|d/.test(i) ? t[n] = lay.digit(e.date, i.length) : /HH|xyz.yuhang.test.H/.test(i) ? t[n] = lay.digit(e.hours, i.length) : /mm|m/.test(i) ? t[n] = lay.digit(e.minutes, i.length) : /ss|s/.test(i) && (t[n] = lay.digit(e.seconds, i.length))
        }), t.join("")
...
!function (e, t) {
    ...
    var ve = function (e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : B) !== xyz.yuhang.test.H && L(t), t = t || xyz.yuhang.test.H, _)) {
        ...
        function i(e) {
            var t = xyz.yuhang.test.H.createElement("div");
            try {
                return !!e(t)
            } catch (n) {
                return !1
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                ...
                for (l && (A = a === xyz.yuhang.test.H || a || l); h !== w && null != (c = x[h]); h++) {
                    if (o && c) {
                        for (f = 0, a || c.ownerDocument === xyz.yuhang.test.H || (L(c), s = !_); d = e[f++];) if (d(c, a || xyz.yuhang.test.H, s)) {
                            u.push(c);
                            break
                        }
                        l && (W = b)
        ...
        var b, w, T, C, E, N, k, S, A, D, j, L, xyz.yuhang.test.H, q, _, F, M, O, R, P = "sizzle" + 1 * new Date, B = e.document, W = 0,
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            return r !== xyz.yuhang.test.H && 9 === r.nodeType && r.documentElement ? (xyz.yuhang.test.H = r, q = xyz.yuhang.test.H.documentElement, _ = !E(xyz.yuhang.test.H), (n = xyz.yuhang.test.H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = i(function (e) {
                return e.appendChild(xyz.yuhang.test.H.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = me.test(xyz.yuhang.test.H.getElementsByClassName), w.getById = i(function (e) {
                return q.appendChild(e).id = P, !xyz.yuhang.test.H.getElementsByName || !xyz.yuhang.test.H.getElementsByName(P).length
            ...
            }, M = [], F = [], (w.qsa = me.test(xyz.yuhang.test.H.querySelectorAll)) && (i(function (e) {
                q.appendChild(e).innerHTML = "<a id='" + P + "'></a><select id='" + P + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && F.push("[*^$]=" + ne + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || F.push("\\[" + ne + "*(?:value|" + te + ")"), e.querySelectorAll("[id~=" + P + "-]").length || F.push("~="), e.querySelectorAll(":checked").length || F.push(":checked"), e.querySelectorAll("a#" + P + "+*").length || F.push(".#.+[+~]")
            }), i(function (e) {
                var t = xyz.yuhang.test.H.createElement("input");
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === xyz.yuhang.test.H || e.ownerDocument === B && R(B, e) ? -1 : t === xyz.yuhang.test.H || t.ownerDocument === B && R(B, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return j = !0, 0;
                var n, r = 0, i = e.parentNode, o = t.parentNode, s = [e], u = [t];
                if (!i || !o) return e === xyz.yuhang.test.H ? -1 : t === xyz.yuhang.test.H ? 1 : i ? -1 : o ? 1 : D ? ee(D, e) - ee(D, t) : 0;
                if (i === o) return a(e, t);
                for (n = e; n = n.parentNode;) s.unshift(n);
                for (n = t; n = n.parentNode;) u.unshift(n);
                for (; s[r] === u[r];) r++;
                return r ? a(s[r], u[r]) : s[r] === B ? -1 : u[r] === B ? 1 : 0
            }, xyz.yuhang.test.H) : xyz.yuhang.test.H
        }, t.matches = function (e, n) {
            return t(e, null, null, n)
        }, t.matchesSelector = function (e, n) {
            if ((e.ownerDocument || e) !== xyz.yuhang.test.H && L(e), n = n.replace(ce, "='$1']"), w.matchesSelector && _ && !X[n + " "] && (!M || !M.test(n)) && (!F || !F.test(n))) try {
                var r = O.call(e, n);
                if (r || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (i) {
            }
            return t(n, xyz.yuhang.test.H, null, [e]).length > 0
        }, t.contains = function (e, t) {
            return (e.ownerDocument || e) !== xyz.yuhang.test.H && L(e), R(e, t)
        }, t.attr = function (e, t) {
            (e.ownerDocument || e) !== xyz.yuhang.test.H && L(e);
            ...
            pseudos: {
                not: r(function (e) {
                    ...
                    return e === xyz.yuhang.test.H.activeElement && (!xyz.yuhang.test.H.hasFocus || xyz.yuhang.test.H.hasFocus()) && !!(e.type || e.href || ~e.tabIndex)
                }, enabled: function (e) {
                    return e.disabled === !1
                }, disabled: function (e) {
                    return e.disabled === !0
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, N = t.tokenize = function (e, n) {
            ...
            return 1 & e.compareDocumentPosition(xyz.yuhang.test.H.createElement("div"))
        }), i(function (e) {
    ...
    pe.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = pe.cssProps[s] || (pe.cssProps[s] = xyz.yuhang.test.H(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t];
        ...
        css: function (e, t, n, r) {
            ...
            return t = pe.cssProps[s] || (pe.cssProps[s] = xyz.yuhang.test.H(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = gt(e, t, r)), "normal" === o && t in Tt && (o = Tt[t]), "" === n || n ? (i = parseFloat(o), n === !0 || isFinite(i) ? i || 0 : o) : o
        }
...
layui.define(["jquery", "lay"], function (e) {
    ...
    F.prototype.config = {
        ...
        var e = this, r = e.config, o = e.elemColorBox.find("." + p), n = o.attr("lay-type"),
            ...
            xyz.yuhang.test.H = e.elemColorBox.find("." + g), M = e.elemPicker.find(".layui-colorpicker-pre").children("div"),
            Y = function (i, l, t, c) {
                e.select(i, l, t);
                var a = B({h: i, s: l, b: t});
                if (xyz.yuhang.test.H.addClass(d).removeClass(u), o[0].style.background = "rgb(" + a.r + ", " + a.g + ", " + a.b + ")", "torgb" === n && e.elemPicker.find("." + x).find("input").val("rgb(" + a.r + ", " + a.g + ", " + a.b + ")"), "rgba" === n) {
                    var p = 0;
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.util,
        ...
        F = t(window), I = t(document), xyz.yuhang.test.H = function (e) {
            var i = this;
            i.index = ++d.index, i.config = t.extend({}, i.config, d.config, e), i.render()
        };
    xyz.yuhang.test.H.prototype.config = {
        limit: 10,
        loading: !0,
        cellMinWidth: 60,
        ...
        autoSort: !0,
        text: {none: "\u65e0\u6570\u636e"}
    }, xyz.yuhang.test.H.prototype.render = function () {
        var e = this, a = e.config;
    ...
    }, xyz.yuhang.test.H.prototype.initOpts = function (e) {
        var t = this, i = (t.config, {checkbox: 48, radio: 48, space: 15, numbers: 40});
        e.checkbox && (e.type = "checkbox"), e.space && (e.type = "space"), e.type || (e.type = "normal"), "normal" !== e.type && (e.unresize = !0, e.width = e.width || i[e.type])
    }, xyz.yuhang.test.H.prototype.setInit = function (e) {
        var t = this, i = t.config;
    ...
    }, xyz.yuhang.test.H.prototype.renderToolbar = function () {
        var e = this, a = e.config,
    ...
    }, xyz.yuhang.test.H.prototype.setParentCol = function (e, t) {
    ...
    }, xyz.yuhang.test.H.prototype.setColsPatch = function () {
        var e = this, t = e.config;
    ...
    }, xyz.yuhang.test.H.prototype.setColsWidth = function () {
        ...
        e.loading(!0)
    }, xyz.yuhang.test.H.prototype.resize = function () {
        var e = this;
        e.fullSize(), e.setColsWidth(), e.scrollPatch()
    }, xyz.yuhang.test.H.prototype.reload = function (e, i) {
        var a = this;
    ...
    }, xyz.yuhang.test.H.prototype.errorView = function (e) {
    ...
    }, xyz.yuhang.test.H.prototype.page = 1, xyz.yuhang.test.H.prototype.pullData = function (e) {
    ...
    }, xyz.yuhang.test.H.prototype.eachCols = function (e) {
        var t = this;
        return d.eachCols(null, e, t.config.cols), t
    }, xyz.yuhang.test.H.prototype.renderData = function (e, n, o, r) {
    ...
    }, xyz.yuhang.test.H.prototype.renderTotal = function (e, a) {
    ...
    }, xyz.yuhang.test.H.prototype.getColElem = function (e, t) {
        var i = this, a = i.config;
        return e.eq(0).find(".laytable-cell-" + (a.index + "-" + t) + ":eq(0)")
    }, xyz.yuhang.test.H.prototype.renderForm = function (e) {
        n.render(e, "LAY-table-" + this.index)
    }, xyz.yuhang.test.H.prototype.setThisRowChecked = function (e) {
        var t = this, i = (t.config, "layui-table-click"), a = t.layBody.find('tr[data-index="' + e + '"]');
        a.addClass(i).siblings("tr").removeClass(i)
    }, xyz.yuhang.test.H.prototype.sort = function (e, i, a, l) {
    ...
    }, xyz.yuhang.test.H.prototype.loading = function (e) {
        var i = this, a = i.config;
    ...
    }, xyz.yuhang.test.H.prototype.setCheckData = function (e, t) {
        var i = this, a = i.config, l = d.cache[i.key];
        l[e] && "array" !== layui._typeof(l[e]) && (l[e][a.checkName] = t)
    }, xyz.yuhang.test.H.prototype.syncCheckAll = function () {
    ...
    }, xyz.yuhang.test.H.prototype.getCssRule = function (e, t) {
        var i = this, a = i.elem.find("style")[0], l = a.sheet || a.styleSheet || {}, n = l.cssRules || l.rules;
        layui.each(n, function (i, a) {
            if (a.selectorText === ".laytable-cell-" + e) return t(a), !0
        })
    }, xyz.yuhang.test.H.prototype.fullSize = function () {
    ...
    }, xyz.yuhang.test.H.prototype.getScrollWidth = function (e) {
        var t = 0;
        return e ? t = e.offsetWidth - e.clientWidth : (e = document.createElement("div"), e.style.width = "100px", e.style.height = "100px", e.style.overflowY = "scroll", document.body.appendChild(e), t = e.offsetWidth - e.clientWidth, document.body.removeChild(e)), t
    }, xyz.yuhang.test.H.prototype.scrollPatch = function () {
    ...
    }, xyz.yuhang.test.H.prototype.events = function () {
