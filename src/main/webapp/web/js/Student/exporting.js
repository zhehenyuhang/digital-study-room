...
(function (a) {
        ...
        function (a, e, r, t) {
            ...
            t = function () {
                ...
                a.prototype.setButtonText = function () {
                    var d = this.chart, a = d.exportDivElements, b = d.options.exporting,
    ...
    g(a, "Extensions/Exporting/Exporting.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Chart/Chart.js"], a["Core/Chart/ChartNavigationComposition.js"], a["Core/DefaultOptions.js"], a["Extensions/Exporting/ExportingDefaults.js"], a["Extensions/Exporting/ExportingSymbols.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"],
        ...
        e = t.defaultOptions;
        var l = d.doc, r = d.win, x = b.addEvent, q = b.css, E = b.createElement, K = b.discardElement, F = b.extend,
            P = b.find, G = b.fireEvent, Q = b.isObject, m = b.merge, L = b.objectEach, w = b.pick, R = b.removeEvent,
            S = b.uniqueKey, H;
        (function (e) {
            function t(a) {
                var c = this, d = c.renderer, b = m(c.options.navigation.buttonOptions, a), e = b.onclick,
                    B = b.menuItems, n = b.symbolSize || 12;
                ...
                if (!1 !==
                    ...
                    p.add(c.exportingGroup).align(F(b,
                        {width: p.width, x: w(b.x, c.buttonOffset)}), !0, "spacingBox");
            ...
            function H() {
                var a =
                        l.body, b = this.options.exporting.printMaxWidth,
            ...
            function U(c, d, e, y, g, B, n) {
                var f = this, u = f.options.navigation, A = f.chartWidth, D = f.chartHeight, p = "cache-" + c,
                    v = Math.max(g, B), h = f[p];
                if (!h) {
            ...
            function aa(a, b) {
                ...
                return this.getSVG(m({chart: {borderRadius: 0}}, c.chartOptions, b, {
                    exporting: {
            ...
            function ba() {
                function a(c) {
                    ...
                    if (1 === c.nodeType && -1 === ca.indexOf(c.nodeName)) {
                        ...
                        if (d.isFirefox || d.isMS) for (var t in h) e(h[t], t); else L(h, e);
